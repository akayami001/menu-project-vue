<template>
    <v-navigation-drawer app color="white" right width="290">
        ...
        <strong class="ml-3">Orders</strong>
        <v-list subheader two-line class="mt-1">
            <v-list-item>
                ...
                <v-list-item-content>
                    ...
                    <v-list-item-subtitle>Category
                        <v-btn plain color="#704232" small>200
        ...
        <strong class="ml-5">Availability List</strong>
                                ...
                                <v-col cols="12" md="12">
                                    <v-list-item three-line class="text-center mt-1">
                                        <v-list-item-content>
                                            ...
                                            <v-list-item-subtitle
                                            :class="active ? 'brown--text' : 'black--text'" class="mt-n2 caption">Available</v-list-item-subtitle>
                                        </v-list-item-content>
                                    </v-list-item>
                                </v-col>
                            </v-row>
                                ...
                                <v-col cols="12" md="12">
                                    <v-list-item three-line class="text-center mt-1">
                                        <v-list-item-content>
                                            ...
                                            <v-list-item-subtitle
                                            :class="active ? 'brown--text' : 'black--text'" class="mt-n2 caption">Unavailable</v-list-item-subtitle>
                                        </v-list-item-content>
                                    </v-list-item>
                                </v-col>
                            </v-row>
